...
namespace TileCostCalculator2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double radius = 1;                              //code breaks/errors appear if not defined 
            double tilesArea = 1;                           //code breaks/errors appear if not defined
...

            {
                ...
                if (shape == 3)
                {
                    ...
                    double radiusOrDiametre = Convert.ToInt32(Console.ReadLine());
